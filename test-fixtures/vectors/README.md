...
> **BUNDLED COPY:** These vectors are a verified copy of the canonical test vectors
> at github.com/emotional-data-model/edm-spec/test-vectors/.
> Source of truth is edm-spec. To refresh, copy the latest vectors
> from edm-spec into this directory and re-run the test suite.
> Last copied: 2026-04-22.
